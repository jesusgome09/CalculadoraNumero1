...
public class creditos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Verdana", 3, 24)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
        jLabel1.setText("Creado por:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Jesus Elia Gomez Cogollo");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
            Desktop.getDesktop().browse(new URI("https://github.com/jesusgome09"));
       }catch(Exception ex){
           JOptionPane.showMessageDialog(null, "no tiene internet o que ?");
       }
